<?php
/**
 * Strings for component 'easycastms', language 'fr'
 *
 * @package    mod
...
$string['modulename'] = 'Média EasyCast MS';
$string['modulename_help'] = 'Le module EasyCast MediaServer permet aux professeurs d\'ajouter des médias issus d\'une web TV EasyCast MediaServer en tant que ressources d\'un cours.';
$string['modulename_link'] = 'mod/easycastms/view';
$string['modulenameplural'] = 'Médias EasyCast MS';
$string['pluginadministration'] = 'Administration du module MediaServer';
$string['pluginname'] = 'Connecteur EasyCast MediaServer';
