...
require_capability('mod/easycastms:addinstance', $context);

add_to_log($course->id, 'easycastms', 'edit', 'edit.php?id='.$cm->id, $easycastms_media->id, $cm->id);

// Update 'viewed' state if required by completion system
$completion = new completion_info($course);
$completion->set_module_viewed($cm);

$PAGE->set_url('/mod/easycastms/edit.php', array('id' => $cm->id));

// display media
easycastms_display_media_edition($easycastms_media, $cm, $course);
